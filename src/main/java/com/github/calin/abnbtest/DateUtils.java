...
public class DateUtils {
    ...
    /**
     * Tries to identify a date from the freeform text. The date identified is then adjusted current Date.
     *
    ...
    /**
     * Tries to identify a date from the freeform text. The date identified is then adjusted to reference date
     *
     * @param text          - free form text containing 1 Date
