...
public abstract class BasePage {
     ...
     * <b>seletor-type:value</b> where <b>selector-type</b> can be one of: <i>css, xpath, id, className, linkText,
     * partialLinkText, tagName</i> and value is the string representation of the element identifier
     *
    ...
    protected By getByFor(String value) {
        ...
        switch (selectorDetails[0].toLowerCase()) {
            ...
            default:
                throw new
                        UnsupportedOperationException("Selector type: " + selectorDetails[0] + " not supported");
        }
    }
