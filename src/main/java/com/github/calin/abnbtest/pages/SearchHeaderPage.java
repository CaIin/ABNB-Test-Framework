...
public class SearchHeaderPage extends BasePage {
  ...
  @Value("${locators.homePage.destination}")
  String destinationLocator;

  @Value("${locators.homePage.firstSuggestionTemplate}")
  String firstSuggestionTemplate;

  @Value("${locators.homePage.checkIn}")
  String checkInLocator;

  @Value("${locators.homePage.checkOut}")
  String checkOutLocator;

  @Value("${locators.homePage.guests}")
  String guestsLocator;

  @Value("${locators.homePage.search}")
  ...
  @Autowired
  public SearchHeaderPage(
      FrameworkContext context, DatePickerPage datePickerPage, GuestsPanelPage guestsPanelPage) {
    super(context);
