...
public class GuestsPanelPage extends BasePage {
    ...
    @Value("${locators.GuestsPanelPage.adultsCount}") String adultsCountLocator;
    @Value("${locators.GuestsPanelPage.increaseAdultsCount}") String increaseAdultsLocator;
    @Value("${locators.GuestsPanelPage.decreaseAdultsCount}") String decreaseAdultsLocator;
    @Value("${locators.GuestsPanelPage.childrenCount}") String childrenCountLocator;
    @Value("${locators.GuestsPanelPage.increaseChildrenCount}") String increaseChildrenLocator;
    @Value("${locators.GuestsPanelPage.decreaseChildrenCount}") String decreaseChildrenLocator;
    @Value("${locators.GuestsPanelPage.infantsCount}") String infantsCountLocator;
    @Value("${locators.GuestsPanelPage.increaseInfantsCount}") String increaseInfantsLocator;
    @Value("${locators.GuestsPanelPage.decreaseInfantsCount}") String decreaseInfantsLocator;
    ...
    /**
     * Sets the number of adults send as parameter. Will decrease or increase the selected number of adults
    ...
    /**
     * Sets the number of children send as parameter. Will decrease or increase the selected number of children
    ...
    /**
     * Sets the number of infants send as parameter. Will decrease or increase the selected number of infants
