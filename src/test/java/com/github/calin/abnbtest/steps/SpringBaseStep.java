...
public class SpringBaseStep {
  ...
  @Autowired SearchHeaderPage searchHeaderPage;
  @Autowired TestContext testContext;
  @Autowired SearchResultsPage searchResultsPage;
  @Autowired WebDriver webDriver;
  @Autowired MoreFiltersPage moreFiltersPage;
  @Autowired PropertyDetailsPage propertyDetailsPage;
}
